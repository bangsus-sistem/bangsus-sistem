    ...
    <fragment>
        ...
        <bsb-card class="my-3">
            <bsb-card-body-spinner-error-back
                ...
                :default-back="{ name: 'penalty.materialPenalty' }"
            >
                <h5 class="mb-3">Tambah Denda Bahan</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/penalty/material_penalty', 'post', {
                            resolve: true,
                            reject: false
                        }).then(() => back({ name: 'penalty.materialPenalty' }))
                    "
                >
                    <bsb-form-group>
                        <label>Cabang</label>
