    ...
    <bsb-screen>
        <template v-slot:desktop>
            <tr>
                ...
                <bsb-td justify="center">
                    <bsb-access-wrapper module-ref="division" action-ref="read">
                        <bsb-button-router-link-read :to="{ name: 'hrm.division.read', params: { id: item['id'] } }" />
                    </bsb-access-wrapper>
                    <bsb-access-wrapper module-ref="division" action-ref="update">
                        <bsb-button-router-link-update :to="{ name: 'hrm.division.update', params: { id: item['id'] } }" />
                        <bsb-button-activate v-if="!item['active']" @click="$emit('activate')" />
                        <bsb-button-deactivate v-else @click="$emit('deactivate')" />
                    </bsb-access-wrapper>
                    <bsb-access-wrapper module-ref="division" action-ref="delete">
