<template>
    <fragment>
        ...
        <bsb-card class="my-3">
            ...
            >
                <h5 class="mb-3">Tambah Penugasan Karyawan</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/hrm/employee_assignment', 'post', {
                            resolve: true,
                            reject: false
                        }).then(() => back({ name: 'hrm.employeeAssignment', params: { employeeId: $route.params.employeeId } }))
                    "
                >
                    <bsb-form-group>
                        <label>NIP</label>
                        <bsb-input v-model="resources['employee']['code']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>NIK</label>
                        <bsb-input v-model="resources['employee']['nik']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>Nama Lengkap</label>
                        <bsb-input v-model="resources['employee']['full_name']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>Cabang</label>
                    ...
                    <bsb-form-group>
                        ...
                        <bsb-select-errors v-model="form.data['first_job_title_id']" :errors="form.errors['first_job_title_id']">
