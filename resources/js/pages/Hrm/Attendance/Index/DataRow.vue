    ...
    <bsb-screen>
        <template v-slot:desktop>
            <tr>
                ...
                <bsb-td justify="center">{{ item['attendance_type']['ref'] }}</bsb-td>
                ...
                <bsb-td justify="center">
                    <template v-if="item['image'] != null">
                        <bsb-image-viewer mode="link" :id="item['image']['id']" />
                    </template>
                </bsb-td>
                <bsb-td justify="center">
            ...
            <bsb-list-group-item>
                <bsb-list-group-item-content>
                    <template v-slot:content>
                        ...
                        <small>{{ standardDate(item['attendance_date']) }}</small><br>
                        <small>{{ item['attendance_type']['ref'] }}</small>
                    </template>
