<template>
    <fragment>
        ...
        <bsb-card class="my-3">
            ...
            >
                <h5 class="mb-3">Tambah Mutasi Karyawan</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/hrm/employee_mutation', 'post', {
                            resolve: true,
                            reject: false
                ...
                >
                    <bsb-form-group>
                        <label>NIP</label>
                        <bsb-input v-model="resources['employee_assignment']['employee']['code']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>NIK</label>
                        <bsb-input v-model="resources['employee_assignment']['employee']['nik']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>Nama Lengkap</label>
                        <bsb-input v-model="resources['employee_assignment']['employee']['full_name']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>Cabang</label>
                        <bsb-input :value="resources['employee_assignment']['branch']['code'] + ' - ' + resources['employee_assignment']['branch']['name']" :readonly="true" />
                    </bsb-form-group>
                    <bsb-form-group>
                        <label>Jabatan</label>
                        <bsb-select-errors v-model="form.data['job_title_id']" :errors="form.errors['job_title_id']">
                    ...
                    <bsb-form-group>
                        ...
                        <bsb-input-errors v-model="form.data['start_date']" :errors="form.errors['start_date']" type="date" />
                    </bsb-form-group>
                    <bsb-form-group>
