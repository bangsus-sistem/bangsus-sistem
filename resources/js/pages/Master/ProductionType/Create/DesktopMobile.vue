    ...
    <fragment>
        ...
        <bsb-card class="my-3">
            <bsb-card-body-spinner-error-back
                ...
                :default-back="{ name: 'master.productionType' }"
            >
                <h5 class="mb-3">Tambah Tipe Produksi</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/master/production_type', 'post', {
                            resolve: true,
                            reject: false
                        }).then(() => back({ name: 'master.productionType' }))
                    "
                >
                    <bsb-form-group>
                        <label>Kode</label>
