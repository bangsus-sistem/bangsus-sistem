    ...
    <bsb-screen>
        <template v-slot:desktop>
            <tr>
                ...
                <bsb-td justify="center">
                    <bsb-access-wrapper module-ref="production_type" action-ref="read">
                        <bsb-button-router-link-read :to="{ name: 'master.productionType.read', params: { id: item['id'] } }" />
                    </bsb-access-wrapper>
                    <bsb-access-wrapper module-ref="production_type" action-ref="update">
                        <bsb-button-router-link-update :to="{ name: 'master.productionType.update', params: { id: item['id'] } }" />
                        <bsb-button-activate v-if="!item['active']" @click="$emit('activate')" />
                        <bsb-button-deactivate v-else @click="$emit('deactivate')" />
                    </bsb-access-wrapper>
                    <bsb-access-wrapper module-ref="production_type" action-ref="delete">
