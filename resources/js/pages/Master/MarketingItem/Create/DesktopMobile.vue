    ...
    <fragment>
        ...
        <bsb-card class="my-3">
            <bsb-card-body-spinner-error-back
                ...
                :default-back="{ name: 'master.marketingItem' }"
            >
                <h5 class="mb-3">Tambah Item Marketing</h5>
                <form
                    class="mt-5"
                    @submit.prevent="
                        submitForm('/ajax/master/marketing_item', 'post', {
                            resolve: true,
                            reject: false
                        }).then(() => back({ name: 'master.marketingItem' }))
                    "
                >
                    <bsb-form-group>
                        <label>Kode</label>
