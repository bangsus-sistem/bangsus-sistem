...
class Kernel
{
    ...
    public static $blueprints = [
        ...
        'expectedValue' => Blueprint\Booleans\ExpectedValueBlueprint::class,
        ...
        'disciplinaryParameter' => Blueprint\Foreign\DisciplinaryParameterBlueprint::class,
        ...
        'operationalPhoto' => Blueprint\Foreign\OperationalPhotoBlueprint::class,
        'operationalPhotoType' => Blueprint\Foreign\OperationalPhotoTypeBlueprint::class,
        'operationalPhotoPenaltyType' => Blueprint\Foreign\OperationalPhotoPenaltyTypeBlueprint::class,
