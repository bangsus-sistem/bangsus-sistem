...
use App\Transformer\RelatedCollections\Master\QualityControlParameterRelatedCollection;

class QualityControlTypeRelatedResource extends RelatedResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'note' => $this->note,
            'quality_control_parameters' => new QualityControlParameterRelatedCollection($this->qualityControlParameters),
